...
public class GenerateScriptProgramNodeView
    implements SwingProgramNodeView<GenerateScriptProgramNodeContribution> {
  ...
  @Override
  public void buildUI(
      JPanel panel, ContributionProvider<GenerateScriptProgramNodeContribution> provider) {
  ...
  private Box createAdvancedParamBox(
      ContributionProvider<GenerateScriptProgramNodeContribution> provider) {
